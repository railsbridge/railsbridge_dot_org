    ...
    gCalFlow.prototype.opts = {
      ...
      date_formatter: function(d, allday_p) {
        if (allday_p) {
          ...
          return "" + (d.getMonth()) + "/" + (d.getDate()) +  " " + (d.getHours()) + ":" + (pad_zero(d.getMinutes()));
        }
      },
      daterange_formatter: function(sd, ed, allday_p) {
        if (allday_p) {
          ...
          if (sd.getDate() !== ed.getDate() || sd.getMonth() !== ed.getMonth()) {
            return "" + (this.date_formatter(sd, allday_p)) + " - " + (ed.getMonth()) + "/" + (ed.getDate());
          } else {
            return this.date_formatter(sd, allday_p);
          }
        } else {
          if (sd.getDate() !== ed.getDate() || sd.getMonth() !== ed.getMonth()) {
            return "" + (this.date_formatter(sd, allday_p)) + " - " + (ed.getMonth()) + "/" + (ed.getDate()) + " " + (ed.getHours()) + ":" + (ed.getMinutes());
          } else if (sd.getHours() !== ed.getHours() || sd.getMinutes() !== ed.getMinutes()) {
            return "" + (this.date_formatter(sd, allday_p)) + " - " + (ed.getHours()) + ":" + (pad_zero(ed.getMinutes()));
          } else {
            return this.date_formatter(sd, allday_p);
          }
        }
