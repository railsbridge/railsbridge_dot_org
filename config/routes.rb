RailsbridgeSite2013::Application.routes.draw do
  ...
  match '/about/past-events',  to: 'static_pages#past_events',        as: 'past_events'
  ...
  match '/help/teacher-advice',to: 'static_pages#teacher_advice',     as: 'teacher_advice'
  match '/help/organize',      to: 'static_pages#organize',           as: 'organize'
  match '/help/host',          to: 'static_pages#host',               as: 'host'
  match '/help/donor-faq',     to: 'static_pages#donor_faq',          as: 'donor_faq'
  match '/help/interest-form', to: 'static_pages#interest_form',      as: 'interest_form'
